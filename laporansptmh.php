...
<head>
    ...
    <title>Laporan SPTMH - <?php echo $namaweb;?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Laporan SPTMH</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Laporan SPTMH</li>
                    </ol>
                </div>
                <!-- <div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center text-md-left db">
                                            ...
                                            <h1 class="h1special pull-right d-none d-md-block">Laporan SPTMH</h1>
                                        </div> 
                                    </div>
                                </div>
                                <hr>
                                <div class="">
                                    <form method="POST" action="sptmh.php" target="_blank">
                                    
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-lg-4 col-form-label">NPSN</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="npsn" placeholder="Masukkan Kode NPSN" readonly value="<?=$_SESSION['username'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-lg-4 col-form-label">TA</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="ta" placeholder="Masukkan TA" readonly value="<?=$ta;?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-lg-4 col-form-label">Triwulan</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="tw" placeholder="Masukkan Triwulan" value="<?=$tw;?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-lg-4 col-form-label">Nomor SPTMH</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="nomor_sptmh" placeholder="Masukkan Nomor SPTMH">
                                        </div>
                                    </div>

                                    <button type="submit" class="btn btn-info"><i class="fa fa-file"></i> Proses</button>
                                </div>
