...
include_once 'ceklogin.php';
    ...
    if (!empty($_POST)) {
        $tahun= $_POST['tahun'];
        $sql1= mysqli_query($link,"SELECT count(npsn) as jumlah FROM realisasipengajuanrka WHERE ta='$tahun'");
        $datalama=mysqli_fetch_array($sql1);
        // echo "data lama=".$datalama['jumlah']."<br>";
        $pesan.="Data Lama: ".$datalama['jumlah'];
        if($datalama['jumlah']>0){
            $hapus=mysqli_query($link,"DELETE FROM realisasipengajuanrka WHERE ta='$tahun'");
            if ($hapus) {
                $hapus1=mysqli_query($link,"DELETE FROM anggaranblmcair WHERE ta='$tahun'");
                if ($hapus1) {
        ...
        $targetPath = 'realisasipengajuan/'.$_FILES['file']['name'];
        ...
        if ($FileType=="xlsx") {
            ...
            $sql="";
            $sqlabc="";
            $sql.="INSERT INTO realisasipengajuanrka
            (ta, npsn, belanja_pegawai, belanja_barangjasa, belanja_modal) VALUES ";
            $sqlabc.="INSERT INTO anggaranblmcair
            (ta, npsn, belanja_pegawai, belanja_barangjasa, belanja_modal) VALUES ";
            ...
            if($result){
                // echo "<br>Sukses";
                $resultabc=mysqli_query($link,$sqlabc);
                if ($resultabc) {
                    # code...
                    $sukses=1;
...
<head>
    ...
    <title>Import Realisasi Pengajuan - <?php echo $namaweb;?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Import Realisasi Pengajuan</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Import Realisasi Pengajuan</li>
                    </ol>
                </div>
                <!-- <div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center text-md-left db">
                                            ...
                                            <h1 class="h1special pull-right d-none d-md-block">Realisasi Pengajuan</h1>
                                        </div> 
                                    </div>
                                </div>
                                <hr>
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                <h3>Template XLSX</h3>
                                <hr>
                                <p class="text-justify">Silahkan mengunduh format realisasi pengajuan RKA dalam bentuk excel berikut</p>
                                <div class="text-center">
                                    <a href="format/formatrealisasirka.xlsx">
