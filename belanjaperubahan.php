...
<body class="fix-header card-no-border">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center text-md-left db">
                                            ...
                                            <h1 class="h1special pull-right d-none d-md-block">Belanja (Perubahan)</h1>
                                        </div> 
                                    </div>
                                </div>
                                <hr>
    ...
    <script>
        ...
        $('#dg').datagrid({
            url:"config/belanjaperubahan/getdata.php?npsn="+npsn,
                ...
                },
                {
                    ...
                    formatter:function(value,row){
                        ...
                        switch(row.jenis_belanja){
                            ...
                            case 2:
                            {
                                return '<a href="belanjapersediaan.php?id='+row.id+'"> <button class="btn-xs btn-info"><i class="fa fa-shopping-cart"></i> Belanja Persediaan</button></a>';
                            }
                            break;
                            default:
                            {
        ...
        $('#cg').combogrid({
            panelWidth:500,
            // delay: 250,
            url: 'config/rkaperubahan/combogrid.php?npsn='+npsn,
            idField:'id',
            textField:'uraian',
            mode:'remote',
            fitColumns:false,
        ...
        function editBelanja(){
            ...
            if (row){
                ...
                url = 'config/belanjaperubahan/update.php?id='+row.id;
            }
        }
        ...
        function destroyBelanja(){
            ...
            if (row){
                $.messager.confirm('Confirm','Apakah anda akan menghapus data belanja '+row.nama+'?',function(r){
                    if (r){
                        $.post('config/belanjaperubahan/destroy.php',{id:row.id},function(result){
                            if (result.success){
                                $('#dg').datagrid('reload');    // reload the user data
                                $('#cg').combogrid('grid').datagrid('reload');
                            } else {
