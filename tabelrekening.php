...
<head>
    ...
    <title>Data Kode Rekening - <?php echo $namaweb; ?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Data Kode Rekening</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Data Kode Rekening</li>
                    </ol>
                </div>
                <!-- <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tablerekening" style="font-family: 'Roboto Mono', monospace;" class="dt table table-sm table-bordered nowrap">
                                        <thead>
                                            <tr>
                                                <th>Kode Rekening</th>
                                                <th>Nama Rekening</th>
                                        ...
                                        <tbody>
                                            ...
                                            // while ($r = mysqli_fetch_array($sql)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editrekening.php?id=<?=$r->id;?>"><button class="btn btn-sm btn-info"><i class="mdi mdi-pencil"></i> Edit</button></a>
                                                        <a href="hapusrekening.php?id=<?=$r->id;?>"><button class="btn btn-sm btn-danger"><i class="mdi mdi-delete-variant"></i> Hapus</button></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
