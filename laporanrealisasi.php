...
<head>
    ...
    <title>Laporan Realisasi - <?php echo $namaweb;?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Laporan Realisasi</h3>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center text-md-left db">
                                            ...
                                            <h1 class="h1special pull-right d-none d-md-block">Laporan Realisasi</h1>
                                        </div> 
                                    </div>
                                </div>
                                <hr>
                                <div class="">
                                    <form method="POST" action="lap_realisasi.php" target="_blank">
