...
<head>
    ...
    <title>Laporan Belanja Persediaan - <?php echo $namaweb;?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Laporan Belanja Persediaan</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Laporan Belanja Persediaan</li>
                    </ol>
                </div>
                <!-- <div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center text-md-left db">
                                            ...
                                            <h1 class="h1special pull-right d-none d-md-block">Laporan B.Persediaan</h1>
                                        </div> 
                                    </div>
                                </div>
                                <hr>
                                <div class="">
                                    <form method="POST" action="lap_belanja_persediaan.php" target="_blank">
