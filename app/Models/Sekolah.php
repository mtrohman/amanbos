...
class Sekolah extends Model
{
    ...
    protected $fillable = ['npsn','nama_sekolah','jenjang','status','kecamatan','role','desa','alamat','telepon','foto','nama_kepsek','nip_kepsek','nama_bendahara','nip_bendahara','password'];
