...
include_once 'ceklogin.php';
    ...
    if (!empty($_POST)) {
        ...
        $sqlinsert= mysqli_query($link, "INSERT INTO koderekening (kode_rekening,nama_rekening,parent_id) VALUES ('$koderekening','$namarekening','$parentid')");
        if ($sqlinsert) {
            // echo "sukses";
            header("location: tabelrekening.php");
        }
        else{
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="text" name="parent" placeholder="Pilih Parent" id="parent" readonly>
                                                <input id="idrekening" name="idparent" type="text" hidden>
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="koderekening"></span>
                                                </div>
                                                <input class="form-control" type="text" name="koderekening" placeholder="Masukkan Kode Rekening">
                                            </div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" type="text" name="namarekening" placeholder="Masukkan Nama Rekening">
                                        </div>
                                    </div>
