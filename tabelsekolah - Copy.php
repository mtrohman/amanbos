                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tablesekolah" style="font-family: 'Roboto Mono', monospace;" class="dt table table-bordered table-sm nowrap">
                                        <thead>
                                            <tr>
                                                <th>NPSN</th>
                                                <th>Nama Sekolah</th>
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = mysqli_query($link,'SELECT * FROM sekolah LEFT JOIN kecamatan ON sekolah.kecamatan=kecamatan.id ORDER BY sekolah.id_sekolah ASC');
                                                while ($r = mysqli_fetch_array($sql)) {
                                            ?>
                                            <tr>
                                                <td><?php echo $r['npsn'];?></td>
                                                <td><?php echo $r['nama_sekolah'];?></td>
                                                <td class="text-center"><?php echo $r['jenjang'];?></td>
                                                <td><?php echo $r['status'];?></td>
                                                <td><?php echo $r['nama_kecamatan'];?></td>
                                                <td>
                                                    <?php echo (is_null($r['telepon'])) ? "-" : $r['telepon']; ?>
                                                </td>
                                                <td>
                                                    <?php echo (is_null($r['nama_kepsek'])) ? "-" : $r['nama_kepsek']; ?>
                                                </td>
                                                <td>
                                                    <?php echo (is_null($r['nip_kepsek'])) ? "-" : $r['nip_kepsek']; ?>
                                                </td>
                                                <td>
                                                    <?php echo (is_null($r['nama_bendahara'])) ? "-" : $r['nama_bendahara']; ?>
                                                </td>
                                                <td>
                                                    <?php echo (is_null($r['nip_bendahara'])) ? "-" : $r['nip_bendahara']; ?>
                                                </td>
