...
if (!empty($_GET['id'])) {
    $idperubahan = $_GET['id'];
    $sqldataperubahan = "SELECT pr.*, s.nama_sekolah FROM perubahanrka pr LEFT JOIN sekolah s ON pr.npsn=s.npsn WHERE id=" . $idperubahan;
    $fetchdataperubahan = mysqli_query($link, $sqldataperubahan);
    $dataperubahan = mysqli_fetch_assoc($fetchdataperubahan);
}
if (!empty($_POST)) {
    // var_dump($_POST);
    $tahun = $_POST['ta'];
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <input class="form-control" type="text" name="ta" placeholder="Masukkan TA" value="<?php echo $dataperubahan['ta']; ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <select name="triwulan" id="trwln" class="form-control" readonly>
                                                <!-- <option value="0">Pilih Triwulan</option> -->
                                                <?php
                                                for ($i = 1; $i <= 4; $i++) {
                                                    $selectVal[$i] = ($dataperubahan['triwulan'] == $i) ? "selected" : "";
                                                    if ($dataperubahan['triwulan'] == $i) {
                                                        # code...
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="input-group">
                                                <input class="form-control" type="text" name="npsn" id="kodenpsn" placeholder="Masukkan NPSN" value="<?php echo $dataperubahan['npsn']; ?>" readonly>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <input class="form-control" type="text" name="sekolah" id="namasekolah" placeholder="Masukkan Nama Sekolah" value="<?php echo $dataperubahan['nama_sekolah']; ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="input-group">
                                                ...
                                                <input class="mask form-control" data-inputmask="'alias': 'rupiah'" type="text" name="kekurangan" placeholder="Masukkan Kekurangan" value="<?php echo $dataperubahan['tambahan_kekurangan']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="input-group">
                                                ...
                                                <input class="mask form-control" data-inputmask="'alias': 'rupiah'" type="text" name="kelebihan" placeholder="Masukkan Kelebihan" value="<?php echo $dataperubahan['kelebihan_dikembalikan']; ?>">
                                            </div>
                                        </div>
                                    </div>
