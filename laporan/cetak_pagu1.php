...
<title>Cetak Data Pagu RKAS-1</title>
<style type="text/css">
    ...
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="33%"><table width="100%" border="0">
            <tr>
              <td class="pala_judul"><div align="center">Laporan Data Pagu RKAS-1</div></td>
            </tr>
            <tr>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
  <tr class="style6">
    ...
    <td width="10%"><div align="center">NPSN</div></td>
    <td width="30"><div align="center">Nama Sekolah</div></td>
    <td width="5%"><div align="center">TA</div></td>
    <td width="10%"><div align="center">Pagu</div></td>
    <td width="10%"><div align="center">TW-1</div></td>
    <td width="10%"><div align="center">TW-2</div></td>
    <td width="10%"><div align="center">TW-3</div></td>
    <td width="10%"><div align="center">TW-4</div></td>
  </tr>
