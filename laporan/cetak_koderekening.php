...
<title>Cetak data rekening</title>
<style type="text/css">
    ...
    sadsadada
      ...
      <tr>
        ...
        <td width="33%"><table width="100%" border="0">
            <tr>
              <td class="pala_judul"><div align="center">Laporan Data Rekening </div></td>
            </tr>
            <tr>
...
<table width="60%" border="1" cellpadding="0" cellspacing="0">
  <tr class="style6">
    ...
    <td width="10%"><div align="center">Kode Rekening</div></td>
    <td width="45%"><div align="center">Nama Rekening</div></td>
