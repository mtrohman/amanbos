...
<title>Cetak data komponen bos</title>
<style type="text/css">
...
<img src="http://bos.aplikasikami.com/laporan/kopdisbud2.png">
  <tr>
    ...
    <!-- <img src="http://bos.aplikasikami.com/laporan/qqq.PNG"> -->
    <script>
    <div class="container"
    sadsadada
    </div>
      ...
      <tr>
        ...
        <td width="33%"><table width="100%" border="0">
            <tr>
              <td class="pala_judul"><div align="center">Laporan Data Komponen Bos </div></td>
            </tr>
            <tr>
...
<table width="60%" border="1" cellpadding="0" cellspacing="0">
  <tr class="style6">
    ...
    <td width="10%"><div align="center">Kode</div></td>
    <td width="45%"><div align="center">Nama Komponen Bos</div></td>
