    ...
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="33%"><table width="100%" border="0">
            <tr>
              <td class="pala_judul"><div align="center">Laporan Data Sekolah </div></td>
            </tr>
            <tr>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
  <tr class="style6">
    ...
    <td width="15%"><div align="center">Nama Sekolah</div></td>
    <td width="20%"><div align="center">Alamat</div></td>
    <td width="10%"><div align="center">Kecamatan</div></td>
    <td width="5%"><div align="center">Telpon</div></td>
    <td width="10%"><div align="center">Nama Kepsek</div></td>
    <td width="5%"><div align="center">NIP Kepsek</div></td>
    <td width="10%"><div align="center">Nama Gendahara</div></td>
    <td width="5%"><div align="center">NIP Bendahara</div></td>
    <td width="5%"><div align="center">Jenjang</div></td>
