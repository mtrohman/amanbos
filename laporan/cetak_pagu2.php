...
<title>Cetak Data Pagu RKAS-2</title>
<style type="text/css">
    ...
    <td><table width="100%" border="0">
      <tr>
        ...
        <td width="33%"><table width="100%" border="0">
            <tr>
              <td class="pala_judul"><div align="center">Laporan Data Pagu RKAS-2</div></td>
            </tr>
            <tr>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
  <tr class="style6">
    ...
    <td width="20%"><div align="center">Kecamatan</div></td>
    <td width="5%"><div align="center">Jenjang</div></td>
    <td width="10%"><div align="center">Status</div></td>
    <td width="10%"><div align="center">BOS 2019</div></td>
    <td width="10%"><div align="center">SALDO BOS 2018</div></td>
