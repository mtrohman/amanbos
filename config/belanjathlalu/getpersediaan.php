...
// 'npsn', 'like', '%' .$npsn. '%'
$belanja = Belanja::thBerjalan()->with(['rka.program','rka.kp','rka.sekolah','rka.rekening'])->ta($ta)->triwulan($triwulan)->npsn($npsn)->namaSekolah($sekolah)->persediaan()->skip($offset)->take($rows)->get();

$belanjacount = Belanja::thBerjalan()->with(['rka.program','rka.kp','rka.sekolah'])->ta($ta)->triwulan($triwulan)->npsn($npsn)->namaSekolah($sekolah)->persediaan()->count();
