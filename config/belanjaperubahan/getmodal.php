...
// 'npsn', 'like', '%' .$npsn. '%'
$belanja = Belanja::perubahan()->with(['rka.program','rka.kp','rka.sekolah','rka.rekening'])->ta($ta)->triwulan($triwulan)->npsn($npsn)->namaSekolah($sekolah)->modal()->skip($offset)->take($rows)->get();

$belanjacount = Belanja::perubahan()->with(['rka.program','rka.kp','rka.sekolah'])->ta($ta)->triwulan($triwulan)->npsn($npsn)->namaSekolah($sekolah)->modal()->count();
