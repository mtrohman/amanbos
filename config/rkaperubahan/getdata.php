...
// 'npsn', 'like', '%' .$npsn. '%'
$rka = Rka::ta($ta)->triwulan($triwulan)->npsn($npsn)->namaSekolah($sekolah)->perubahan()->with(['sekolah', 'program', 'kp'])->skip($offset)->take($rows)->get();
$rkacount = Rka::ta($ta)->triwulan($triwulan)->npsn($npsn)->namaSekolah($sekolah)->perubahan()->count();
