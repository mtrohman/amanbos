...
<body class="fix-header card-no-border">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="text-center text-md-left db">
                                            ...
                                            <h1 class="h1special pull-right d-none d-md-block">Pagu Perubahan</h1>
                                        </div> 
                                    </div>
                                </div>
                                <hr>
 ...
 // ;
    ...
    <script>
        ...
        $('#dg').datagrid({
            url:"config/paguperubahan/getdata.php?npsn="+npsn,
            ...
            columns: [[
                ...
                {field:'pagu', width:'150',title:'Pagu Perubahan', formatter:function(value, row){ return cetakIDR(value) }},
                {field:'sisa', width:'150',title:'Sisa', formatter:function(value, row){ return cetakIDR(value) }}
            ]]
        });
        ...
        var url;
		function newPagu(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Pagu Perubahan');
			$('#fm').form('clear');
            $('#cg').combogrid('readonly',false);
			url = 'config/paguperubahan/save.php';
		}
